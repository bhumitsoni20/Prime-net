      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 pt-8 border-t border-white/[0.08] flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-6 bg-white rounded-[4px] flex items-center justify-center text-[8px] font-black text-[#1A1F71] tracking-widest shadow-sm">
              VISA
            </div>
            ...
            <div className="w-10 h-6 bg-white rounded-[4px] flex items-center justify-center text-[9px] font-black italic text-[#64748B] shadow-sm border border-[#F1F5F9]">
              UPI
            </div>
            <div className="w-10 h-6 bg-white rounded-[4px] flex items-center justify-center text-[9px] font-bold text-[#002970] shadow-sm">
              Paytm
            </div>
