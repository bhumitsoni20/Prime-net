...
import { HiPlus, HiTrash, HiCurrencyRupee, HiCheck, HiOutlineSparkles } from 'react-icons/hi';
...
const CreateBundle = () => {
  ...
  const createBundleMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success('Combo bundle created successfully!');
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div>
        ...
        <h1 className="text-[26px] font-extrabold text-[#0F172A] tracking-[-0.02em]">Create Combo Bundle Package</h1>
        <p className="text-[#64748B] text-[14px]">Combine multiple subscription accounts into one high-converting discounted package.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-[24px] p-6 sm:p-7 shadow-[0_1px_3px_rgba(0,0,0,0.04)] space-y-5">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <span className="text-[#64748B] font-semibold text-[14px]">+ Add a subscription to bundle...</span>
