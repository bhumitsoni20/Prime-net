      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-[#0F0F1A] via-[#1A1040] to-[#0F0F1A]">
        ...
        <div className="relative z-10 flex flex-col h-full w-full p-10">
          ...
          <Link to="/" className="flex items-center gap-2.5">
            <div className="h-8 w-8 rounded-[10px] bg-gradient-to-br from-[#5B4BFF] to-[#7C3AED] flex items-center justify-center shadow-[0_4px_12px_rgba(91,75,255,0.3)]">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md">
            ...
            <div className="relative h-56 mb-8">
              <div className="absolute top-0 left-0 h-14 w-14 rounded-[14px] glass-dark flex items-center justify-center animate-float shadow-lg">
                <span className="text-xl font-bold text-red-500">N</span>
              </div>
              <div className="absolute top-4 left-28 h-12 w-12 rounded-[14px] glass-dark flex items-center justify-center animate-float-delayed">
                <span className="text-xl text-green-400">♪</span>
              </div>
              <div className="absolute top-12 right-20 h-14 w-14 rounded-[14px] glass-dark flex items-center justify-center animate-float-slow">
              ...
              <div className="absolute top-20 right-8 h-12 w-12 rounded-[14px] glass-dark flex items-center justify-center animate-float-delayed">
                <span className="text-sm font-bold text-blue-400">D+</span>
              </div>
              <div className="absolute bottom-4 left-32 h-12 w-12 rounded-[14px] glass-dark flex items-center justify-center animate-float-slow">
